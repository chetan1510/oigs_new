...
<div class="sub-header">
    <div class="table-div full">
        <div>
            <h4 class="fs-18 bold" style="margin:0;"> {{ $id ? "Update Jewellery" : "Add Jewellery" }} </h4>
        </div>
        <div class="text-right">
            <a href="{{url('/jewellery')}}"><i class="icons icon-arrow-left"></i> Go Back</a>
        </div>
    </div>
</div>
@endsection
...
<div class="ng-cloak" ng-controller="jewellery_Controller" ng-init="addEditInit('{{$id}}')">
