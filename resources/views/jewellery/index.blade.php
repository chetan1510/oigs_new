	...
	<div class="page-header row">
		...
		<div class="col-6">
			<div class="text-right">
				...
				<a href="{{ url('/jewellery/add') }}" class="btn btn-primary"><i class="icons icon-plus"></i> Add Jewellery</a>
			</div>
		</div>
	</div>
				...
				<table class="table table-compact">
					...
					<tbody>
						<tr ng-repeat="data in dataset track by $index">
							...
							<td>
								<a href="{{ url('/jewellery/add/') }}/@{{data.id}}" class="btn btn-sm btn-primary">Edit</a>
