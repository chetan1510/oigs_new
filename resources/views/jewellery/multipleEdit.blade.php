...
@section('content')
	<div class="ng-cloak" ng-controller="jewellery_Controller" ng-init="editMultipleJewelleryInit('{{$jewelleryIds}}')">
		<div class="portlet">
								...
								<tr ng-repeat="jewellery in multipleJewellery track by $index" class="form-group">
									...
									<td>
										<div ng-if="jewellery.prod_image">
				                            <a href="{{ url('/') }}/@{{jewellery.prod_image}}" class="btn btn-sm btn-info form-control size-multiple-edit" target="_blank">View</a>
