...
@section('content')
	<div class="ng-cloak" ng-controller="rudraksha_Controller" ng-init="editMultipleRudrakshaInit('{{$rudrakshaIds}}')">
		<div class="portlet">
								...
								<tr ng-repeat="rudraksha in multipleRudraksha track by $index" class="form-group">
									...
									<td>
										<div ng-if="rudraksha.prod_image">
				                            <a href="{{ url('/') }}/@{{rudraksha.prod_image}}" class="btn btn-sm btn-info form-control size-multiple-edit" target="_blank">View</a>
