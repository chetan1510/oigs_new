...
<div class="sub-header">
    <div class="table-div full">
        <div>
            <h4 class="fs-18 bold" style="margin:0;"> {{ $id ? "Update Rudraksha" : "Add Rudraksha" }} </h4>
        </div>
        <div class="text-right">
            <a href="{{url('/rudraksha')}}"><i class="icons icon-arrow-left"></i> Go Back</a>
        </div>
    </div>
</div>
@endsection
...
<div class="ng-cloak" ng-controller="rudraksha_Controller" ng-init="addEditInit('{{$id}}')">
