...
Route::group([], function(){
    ...
    Route::post('/get-class-section',[GeneralController::class, 'getClassSection']);
    Route::post('/get-house',[GeneralController::class, 'getHouse']);
    Route::post('/get-blood-group',[GeneralController::class, 'getBloodGroup']);
    Route::post('/get-categories',[GeneralController::class, 'getCategories']);
    ...
    Route::get('/groups/{center_id}',[GeneralController::class, 'getGroupList']);
    ...
    Route::group(["prefix"=>"class-and-section"], function(){
        Route::post('/list',[manageController::class, 'getList']);
        Route::post('/save',[manageController::class, 'save']);
        Route::get('/delete/{id}',[manageController::class, 'delete']);
    });

    Route::group(["prefix"=>"house"], function(){
        Route::post('/house-list',[manageController::class, 'houseList']);
        Route::post('/save',[manageController::class, 'saveHouse']);
        Route::get('/delete/{id}',[manageController::class, 'deleteHouse']);
    });
