...
<div class="" ng-controller="diamond_controller" ng-init="getList()">
	...
	<div class="page-header row">
		...
		<div class="col-6">
			<div class="text-right">
				<button  class="btn btn-info" ng-click="printDiamond()"><i class="icons icon-printer"></i> Print</button>
				<a href="<?php echo e(url('/diamond/add')); ?>" class="btn btn-primary"><i class="icons icon-plus"></i> Add Diamond</a>
			</div>
		</div>
	</div>
	...
	<div class="portlet">
		<div class="portlet-body ng-cloak">
			...
			<?php echo $__env->make("diamond.filters", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				...
				<table class="table table-compact">
					...
					<tbody>
						<tr ng-repeat="data in dataset track by $index">
							...
							<td><input type="checkbox" ng-click="addSelecteddiamond(data)" ng-checked="diamondIds.indexOf(data.id) > -1"></td>
							...
							<td>
								<a href="<?php echo e(url('/diamond/add/')); ?>/{{data.id}}" class="btn btn-sm btn-primary">Edit</a>
	...
	<div class="modal fade in" id="printDiamondModel" role="dialog">
	    <div class="modal-dialog">
	        <div class="modal-content">
	            <div class="modal-header">
	                <h4 class="modal-title">Print diamond Report</h4>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oigs_new\resources\views/diamond/index.blade.php ENDPATH**/ ?>