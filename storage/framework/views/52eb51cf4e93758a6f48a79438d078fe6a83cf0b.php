...
<div class="" ng-controller="gems_controller" ng-init="getList()">
	...
	<div class="page-header row">
		...
		<div class="col-6">
			<div class="text-right">
				...
				<a href="<?php echo e(url('/gems/add')); ?>" class="btn btn-primary"><i class="icons icon-plus"></i> Add Gems</a>
			</div>
		</div>
	</div>
	...
	<div class="portlet">
		<div class="portlet-body ng-cloak">
			...
			<?php echo $__env->make("gems.filters", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				...
				<table class="table table-compact">
					...
					<tbody>
						<tr ng-repeat="data in dataset track by $index">
							...
							<td>
								<a href="<?php echo e(url('/gems/add/')); ?>/{{data.id}}" class="btn btn-sm btn-primary">Edit</a>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/oigs_new/resources/views/gems/index.blade.php ENDPATH**/ ?>