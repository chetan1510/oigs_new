...
<div class="sub-header">
    <div class="table-div full">
        <div>
            <h4 class="fs-18 bold" style="margin:0;"> <?php echo e($id ? "Update Diamond" : "Add Diamond"); ?> </h4>
        </div>
        <div class="text-right">
            <a href="<?php echo e(url('/diamond')); ?>"><i class="icons icon-arrow-left"></i> Go Back</a>
        </div>
    </div>
</div>
...
<div class="ng-cloak" ng-controller="diamond_controller" ng-init="addEditInit('<?php echo e($id); ?>')">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oigs_new\resources\views/diamond/create.blade.php ENDPATH**/ ?>