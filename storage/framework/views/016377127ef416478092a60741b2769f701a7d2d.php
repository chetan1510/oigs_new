...
<?php $__env->startSection('content'); ?>
	<div class="ng-cloak" ng-controller="gems_controller" ng-init="editMultipleGemsInit('<?php echo e($gemsIds); ?>')">
		<div class="portlet">
								...
								<tr ng-repeat="gems in multipleGems track by $index" class="form-group">
									...
									<td>
										<div ng-if="gems.prod_image">
				                            <a href="<?php echo e(url('/')); ?>/{{gems.prod_image}}" class="btn btn-sm btn-info form-control size-multiple-edit" target="_blank">View</a>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/oigs_new/resources/views/gems/multipleEdit.blade.php ENDPATH**/ ?>