...
<?php $__env->startSection('content'); ?>
	<div class="ng-cloak" ng-controller="diamond_controller" ng-init="editMultipleDiamondInit('<?php echo e($diamondIds); ?>')">
		<div class="portlet">
								...
								<tr ng-repeat="diamond in multipleDiamond track by $index" class="form-group">
									...
									<td>
										<div ng-if="diamond.prod_image">
				                            <a href="<?php echo e(url('/')); ?>/{{diamond.prod_image}}" class="btn btn-sm btn-info form-control size-multiple-edit" target="_blank">View</a>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oigs_new\resources\views/diamond/multipleEdit.blade.php ENDPATH**/ ?>