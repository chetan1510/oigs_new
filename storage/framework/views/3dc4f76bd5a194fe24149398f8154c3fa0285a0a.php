	...
	<form ng-submit="searchList()">
		<div class="row">
          ...
          <div class="form-group mt-3">
            ...
            <input type="text" ng-model="filter.created_at" class="form-control datepicker" autocomplete="off" >
          </div>
        </div>
...
</div><?php /**PATH /Applications/MAMP/htdocs/oigs_new/resources/views/jewellery/filters.blade.php ENDPATH**/ ?>