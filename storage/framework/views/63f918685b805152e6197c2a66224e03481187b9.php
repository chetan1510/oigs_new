...
<div class="sub-header">
    <div class="table-div full">
        <div>
            <h4 class="fs-18 bold" style="margin:0;"> <?php echo e($id ? "Update Jewellery" : "Add Jewellery"); ?> </h4>
        </div>
        <div class="text-right">
            <a href="<?php echo e(url('/jewellery')); ?>"><i class="icons icon-arrow-left"></i> Go Back</a>
        </div>
    </div>
</div>
...
<div class="ng-cloak" ng-controller="jewellery_Controller" ng-init="addEditInit('<?php echo e($id); ?>')">
    ...
    <div class="portlet">
      ...
      <div class="portlet-body" ng-if="!loading">
        ...
        <div class=" mt-1">
            ...
            <form method="POST" name="JewelleryForm" ng-submit="onSubmitJewellery(JewelleryForm.$valid)" novalidate="novalidate" >
                <div class="row">
                    ...
                    <div class="col-sm-6 form-group">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" ng-model="formData.gross_weight">
                            </div>
                            <div class="col-sm-6">
                                <label>Type</label>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 form-group">
                        ...
                        <input type="text" class="form-control" ng-model="formData.porosity">
                    </div>

                    <div class="col-sm-3 form-group">
                        <label>Shape Of Product</label>
                        <input type="text" class="form-control" ng-model="formData.shape_of_product">
                    </div>
                    ...
                    <div class="col-sm-3 form-group">
                        ...
                        <input type="text" class="form-control" ng-model="formData.hallmark">
                    </div>

                    <div class="col-sm-3 form-group">
                        <label>Loose Diamond</label>
                        <input type="text" class="form-control" ng-model="formData.loose_diamond">
                    </div>
                </div>  
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 form-group">
                        <div class="row">
                            <div class="col-sm-6">
                                <label>Color Stone Weight</label>
                                <input type="text" class="form-control" ng-model="formData.color_stone_weight">
                            </div>
                            <div class="col-sm-6">
                                <label>Type</label>
                                <select ng-model="formData.ctss" class="form-control" convert-to-number>
                                    <option ng-repeat="weight in weightType" value="{{weight.id}}">{{weight.type}}</option>
                                </select>
                            </div>
                        </div> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oigs_new\resources\views/jewellery/create.blade.php ENDPATH**/ ?>