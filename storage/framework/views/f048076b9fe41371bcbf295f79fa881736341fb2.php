...
<div class="" ng-controller="rudraksha_Controller" ng-init="getList()">
	...
	<div class="page-header row">
		...
		<div class="col-6">
			<div class="text-right">
				<button  class="btn btn-info" ng-click="printRudraksha()"><i class="icons icon-printer"></i> Print</button>
				<a href="<?php echo e(url('/rudraksha/add')); ?>" class="btn btn-primary"><i class="icons icon-plus"></i> Add Rudraksha</a>
			</div>
		</div>
	</div>
	...
	<div class="portlet">
		<div class="portlet-body ng-cloak">
			...
			<?php echo $__env->make("rudraksha.filters", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				...
				<table class="table table-compact">
					...
					<tbody>
						<tr ng-repeat="data in dataset track by $index">
							...
							<td><input type="checkbox" ng-click="addSelectedRudraksha(data)" ng-checked="RudrakshaIds.indexOf(data.id) > -1"></td>
							...
							<td>
								<a href="<?php echo e(url('/rudraksha/add/')); ?>/{{data.id}}" class="btn btn-sm btn-primary">Edit</a>
			...
			<div ng-if="rudrakshaIds.length > 0">
				<div class="row">
					<div class="col-md-4">
	...
	<div class="modal fade in" id="printRudrakshaModel" role="dialog">
	    <div class="modal-dialog">
	        <div class="modal-content">
	            <div class="modal-header">
	                <h4 class="modal-title">Print Rudraksha Report</h4>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oigs_new\resources\views/rudraksha/index.blade.php ENDPATH**/ ?>